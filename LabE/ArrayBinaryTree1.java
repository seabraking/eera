...
public class ArrayBinaryTree1<T> implements BinaryTreeInterface<T>,java.io.Serializable
{
    private T   theData[];
    ...
    public ArrayBinaryTree1(T rootData)
    {
        setTree(rootData);
    } 
    ...
    public ArrayBinaryTree1(T rootData, ArrayBinaryTree1<T> leftTree,
                                       ArrayBinaryTree1<T> rightTree)
    {
        ...
        {
            setTree(rootData, (ArrayBinaryTree1<T>) leftTree, 
                (ArrayBinaryTree1<T>) rightTree); 
        }    
    } 
                                    ...
                                    BinaryTreeInterface<T> rightTree)
    {
        ...
        {
            ArrayBinaryTree1<T> lTree = (ArrayBinaryTree1<T>) leftTree; 
            ArrayBinaryTree1<T> rTree = (ArrayBinaryTree1<T>) rightTree; 
            ...
            setLeftSubtree((ArrayBinaryTree1<T>) leftTree);
            setRightSubtree((ArrayBinaryTree1<T>) rightTree);
        }
     ...
     */
    private void setLeftSubtree(ArrayBinaryTree1<T> subTree)
    {
     ...
     * Precondition: The array theData is large enough to hold the new values.
     */
    private void setRightSubtree(ArrayBinaryTree1<T> subTree)
    {
        // IT TAKES IN THE VALUES OF THE LEFT SUBTREE AND ADDS THEM TO THE ARRAY
